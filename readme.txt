...
NAME2: Maria Francisca Paup?rio, NR2: 201403785, GRADE2: 20, CONTRIBUTION2: 33%
...
Our solution starts by identifying in the tree obtained from the parser, the existing pragmas and variables in the code. Saving the necessary information, such as, the max, min and reference values for the pragma ?explore?. 
